...
export type ButtonVariantProps = 'contained' | 'light' | 'outlined' | 'dashed' | 'text' | 'shadow' | 'greyLight';
export type IconButtonShapeProps = 'rounded' | 'square';
export type ColorProps = ChipProps['color'] | ButtonProps['color'] | IconButtonProps['color'] | SliderProps['color'];
